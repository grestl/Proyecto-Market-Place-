...
INSERT INTO `marketplacebd`.`persona` (`idpersona`, `nombre`, `apellido`, `telefono`, `foto`, `correo`) VALUES ('4', 'Comprador', 'Compa1', '312', 'not', 'asd4@gmail.com');
INSERT INTO `marketplacebd`.`persona` (`idpersona`, `nombre`, `apellido`, `telefono`, `foto`, `correo`) VALUES ('5', 'Comprador2', 'Compa2', '231', 'not', 'asd5@gmail.com');
